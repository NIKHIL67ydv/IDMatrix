...
by Nikhil 24BCE10903 , Department of Computer Science & Engineering

This guide explains how to set up, run, and use the ID Matrix application to manage citizen records efficiently.
...
ID Matrix uses a CSV file for permanent storage.
